...
<body>
	<table width=600 align=center>
		...
		<tr class="content">
			...
			<h2>修改會員訂單</h2><br>登入者:<%=m.getUser() %><br><br><br>
			<form action="../manageUpdateOrder" method="post">
					<table width=70% align=center>
						...
						<tr align=center>
							<td>
							product1 <input type="text" name="product1" size="5">
							product2 <input type="text" name="product2" size="5">
						<tr align=center>
							<td>
							product3 <input type="text" name="product3" size="5">
							product4 <input type="text" name="product4" size="5">
							product5 <input type="text" name="product5" size="5">
